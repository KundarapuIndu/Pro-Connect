...

      {
        ...
        <div
          ...
          <div
            ...
            <input onChange={handleWorkInputChange} name='company' className={styles.inputField} type="password" placeholder='Company' />
            <input onChange={handleWorkInputChange} name='position' className={styles.inputField} type="password" placeholder='Enter Position' />
