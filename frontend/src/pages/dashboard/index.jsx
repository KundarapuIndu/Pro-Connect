        ...
        <div className={styles.scrollComponent}>
          ...
          <div className={styles.wrapper}>
            <div className={styles.createPostContainer}>
              ...
              <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} name={styles.textAreaOfContent} id="" placeholder="What's in your mind"></textarea>
              ...
              <input onClick={(e) => setFileContent(e.target.files[0])} type="file" hidden id='fileUpload' />
